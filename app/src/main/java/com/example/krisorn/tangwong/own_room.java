...
public class own_room extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                own_room.this, drawer, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
        drawer.addDrawerListener(toggle);
        toggle.syncState();
        NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view_own_room);
        Log.d("testSideNav","---------------");
        navigationView.setNavigationItemSelectedListener(own_room.this);
